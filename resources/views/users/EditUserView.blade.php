                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.updateProfile') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="givenname" type="text" class="form-control @error('givenname') is-invalid @enderror" name="givenname" value="{{ $user->givenname }}" required autocomplete="givenname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role_request" type="text" class="form-control @error('role_request') is-invalid @enderror" name="role_request" required autocomplete="role_request" autofocus>
